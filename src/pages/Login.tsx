...
//         description: "Welcome back to Legalyze!",
//       });
//       navigate('/home');
//     }, 2000);
//   };
...
//             <span className="text-3xl font-bold text-primary">Legalyze</span>
//           </Link>
//           <p className="text-muted-foreground mt-2">Sign in to your account</p>
//         </div>

//         {/* Login Form */}
//         <Card className="shadow-hero border-0 bg-gradient-card">
...
const Login = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-100 to-slate-200 flex items-center justify-center p-4">
      ...
      {/* Main container */}
      <div className="max-w-6xl w-full bg-[#002366] rounded-2xl shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
        
        {/* Left side Illustration */}
        <div className="hidden md:flex md:w-full items-center justify-center bg-gray-900">
          <img
            src={illustration}
            alt="Illustration"
            ...
            <CardContent>
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-gray-300 text-blue-900 text-xl hover:bg-white hover:opacity-90"
                  size="lg"
                >
                  {isLoading ? "Signing in..." : "Sign In"}
                </Button>
